...
public class GearChange extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gear_change); //Sets the mentioned layout as the display when this activity is running.
