...
public class FuelSaved extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fuel_saved); //Sets the mentioned layout as the display when this activity is running.
